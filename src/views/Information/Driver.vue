    ...
    <el-dialog title="修改司机信息" :visible.sync="editDialogVisible" width="40%" @close="editDialogClosed">
      <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="90px">
        ...
        <el-form-item label="城市">
          <el-input v-model="editForm.userCity"></el-input>
        </el-form-item>
        <el-form-item label="地址">
          <el-input v-model="editForm.userAddress"></el-input>
        </el-form-item>
        <el-form-item label="注册时间">
          <el-input v-model="editForm.userTime" disabled></el-input>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    editUserInfo () {
      ...
      this.$refs.editFormRef.validate(async valid => {
        ...
        // 发起修改信息的数据申请
        // eslint-disable-next-line no-unused-vars
        const { data } = await editUser(this.editForm.userId, this.editForm.userCity, this.editForm.userAddress)
        console.log(data.data)
        if (data.code !== 20000) {
